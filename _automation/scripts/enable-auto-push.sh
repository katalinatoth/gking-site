...
#
# This script lives at _automation/scripts/enable-auto-push.sh and points
# git at .githooks/ which stays at the repo root (so `git config
# core.hooksPath .githooks` resolves the same way every developer expects).
set -e
