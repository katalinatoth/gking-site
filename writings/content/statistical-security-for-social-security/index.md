...
abstract: |-
  ...
  This work builds on our article that provides forecasts of US Mortality rates (see King and Soneji, [The Future of Death in America](/publication/the-future-of-death-in-america/)), a book developing improved methods for forecasting mortality (Girosi and King, [Demographic Forecasting](/publication/demographic-forecasting-2008/)), all data we used (King and Soneji, [replication data sets](http://hdl.handle.net/1902.1/16178)), and open source software that implements the methods (Girosi and King, [YourCast](/software/yourcast/)). Also available is a *New York Times* Op-Ed based on this work (King and Soneji, [Social Security: It's Worse Than You Think](http://www.nytimes.com/2013/01/06/opinion/sunday/social-security-its-worse-than-you-think.html)), and a replication data set for the Op-Ed (King and Soneji, [replication data set](http://hdl.handle.net/1902.1/19822)).
authors:
- Samir Soneji
- Gary King
date: '2012-01-01'
...
- type: pdf
  url: files/ssc.pdf
- type: source
  url: http://link.springer.com/article/10.1007%2Fs13524-012-0106-z
