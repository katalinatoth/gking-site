#!/usr/bin/env python3
"""Capture the first-commit date for every /content/publication/ markdown.
...
This script walks content/publication/*/index.md, asks git for each
file's earliest commit timestamp, and writes the result to
data/publication_first_commit.json as {slug: iso8601-date}. Hugo reads
that file to order the spotlight.
...
def main() -> int:
    ...
    pub_dir = repo_root / "content" / "publication"
    out_path = repo_root / "data" / "publication_first_commit.json"
