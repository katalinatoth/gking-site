#!/usr/bin/env python3
"""
Scrape https://gking.harvard.edu/people and sync data/research_group.json plus
content/people/<slug>/index.md (role + research_group_category).
...
DATA_OUT = ROOT / "data" / "research_group.json"
