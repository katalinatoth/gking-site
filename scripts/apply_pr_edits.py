...
intake PR. The workflow runs:
    ...
    python3 scripts/apply_pr_edits.py \
        --comment /tmp/comment_body.txt \
        --report  /tmp/edit_report.json \
        content/publication/foo/index.md [content/publication/bar/index.md ...]
...
Manual local use:
    ...
    python3 scripts/apply_pr_edits.py \
        ...
        content/publication/foo/index.md
"""
...
# files generated at intake time.
...
def main() -> int:
    ...
    ap.add_argument("--legacy-map", type=Path,
                    default=ROOT / "data" / "writings_legacy_map.json",
