...
abstract: |-
  ...
  This work builds on our article that provides forecasts of US Mortality rates (see King and Soneji, [The Future of Death in America](https://gking.harvard.edu/publications/future-death-america)), a book developing improved methods for forecasting mortality (Girosi and King, [Demographic Forecasting](https://gking.harvard.edu/files/abs/smooth-abs.shtml)), all data we used (King and Soneji, [replication data sets](http://hdl.handle.net/1902.1/16178)), and open source software that implements the methods (Girosi and King, [YourCast](https://gking.harvard.edu/yourcast)).  Also available is a *New York Times* Op-Ed based on this work (King and Soneji, [Social Security: It’s Worse Than You Think](http://www.nytimes.com/2013/01/06/opinion/sunday/social-security-its-worse-than-you-think.html)), and a replication data set for the Op-Ed (King and Soneji, [replication data set](http://hdl.handle.net/1902.1/19822)).
authors:
- Samir Soneji
- Gary King
date: '2012-01-01'
